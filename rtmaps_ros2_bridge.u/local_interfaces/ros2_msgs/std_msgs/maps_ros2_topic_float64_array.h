...
class MAPSros2_topic_float64_array : public MAPSros2_topic_interface
{
public:
    MAPSros2_topic_float64_array(MAPS_ros2* component, std::shared_ptr<rclcpp::Node> node, Endpoint_Type endpointType, std::string& topicName, std::string& inOutName) 
