...
class MAPSros2_topic_int32 : public MAPSros2_topic_interface
{
public:
    MAPSros2_topic_int32(MAPS_ros2* component, std::shared_ptr<rclcpp::Node> node, Endpoint_Type endpointType, std::string& topicName, std::string& inOutName) 
