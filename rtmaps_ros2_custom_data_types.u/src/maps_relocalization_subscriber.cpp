...
void MAPSrelocalization_subscriber::Birth()
{
    ...
    m_sub = m_n->create_subscription<interface_rtmaps_msgs::msg::Relocalization>(topic_name.Beginning(), queue_size, std::bind(&MAPSrelocalization_subscriber::ROSDataReceivedCallback, this, std::placeholders::_1));
    }
    catch (std::exception& e)
    {
        Error(e.what());
...
void MAPSrelocalization_subscriber::ROSDataReceivedCallback(const interface_rtmaps_msgs::msg::Relocalization& message)
{
    try 
    {
